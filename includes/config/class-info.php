...
class Info {
	...
	public function __construct() {
		$this->plugin_setting_option1
			= get_option( 'siawood_products_plugin_setting_option1' );
		$this->plugin_setting_option2
			= get_option( 'siawood_products_plugin_setting_option2' );
		$this->plugin_setting_option3
			= get_option( 'siawood_products_plugin_setting_option3' );
		$this->plugin_setting_option4
			= get_option( 'siawood_products_plugin_setting_option4' );
	}
	...
	public static function add_info_in_plugin_activation() {
		if ( ! get_option( 'siawood_products_plugin_setting_option1' ) ) {
			update_option(
				'siawood_products_plugin_setting_option1',
		...
		if ( ! get_option( 'siawood_products_plugin_setting_option3' ) ) {
			update_option(
				'siawood_products_plugin_setting_option3',
				'Initial value for option 3'
			);
		}
		if ( ! get_option( 'siawood_products_plugin_setting_option4' ) ) {
			update_option(
				'siawood_products_plugin_setting_option4',
